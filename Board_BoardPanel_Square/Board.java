...
/**
 * @author christopher purves, edited by zander winston
 * 
 *The board on which the panel is set. This is where the buttons live, and you can press them to do things. It is a JPanel so
 *you can put it in a JFrame.
 */
public class Board extends JPanel implements ActionListener

{
	int boardID;		//the kind of board being played
	BoardPanel window;	//declares a BoardPanel
	
	String lastButton;	//most recent button clicked

	boolean clicked = false;	//sets default clicked bool to false, added by zander
	

	JFrame board;		//declares board JFrame
	
	Square A1 = new Square("A1");	//set of declarations for squares
	...
	//button declarations, arranged by zander
	...
	/**
	 * highlights a square. Method by zander.
	 * 
	...
	/**
	 * 
	 * getter function for clicked status. method by zander. 
	 * 
	 * @return	;	returns whether or not the button was clicked
	 */
	...
	/**
	 * 
	 * sets whether or not a button is clicked. method by zander.
	 * 
	 * @param x	;	sets a boolean as to whether or not it was clicked
	 */
	...
	/**
	 * 
	 * sets the most recent button clicked. method by zander.
	 * 
	 * @param name	;	returns the button name as a string
	 */
	...
	/**
	 * 
	 * getter that returns the most recent button clicked. method by zander.
	 * 
	 * @return	;	returns the button name as a string
	 */
	...
	//==============================================================================
	/**
	 * initializes the board. constructor by christopher.
	 */
	Board()
	{
		board = new JFrame();	//initializes board object as a JFrame
		window = new BoardPanel();		//initializes the board panel that will display the main game's graphics
		
		window.setLayout(new GridLayout(8,8,0,0));	//sets the grid layout manager to an 8x8 board
		
		window.add(A1);		//adds buttons
		window.add(A2);
		window.add(A3);
		window.add(A4);
		window.add(A5);
		...
		A1.addActionListener(e -> recentButton("A1"));		//adds action listeners for the recent button, modified by zander
		...
		A1.setOpaque(false);					//makes the buttons clear, allowing the graphics to be shown under the buttons
		A2.setOpaque(false);
		A3.setOpaque(false);
		A4.setOpaque(false);
		A5.setOpaque(false);
		...
		this.add(window);		//adds the window to the game graphics
		this.setSize(256,256);	//sets the size of the chessboard
		this.setVisible(true);	//makes everything visible
		
		
		board.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);	//close the operation
